...
# # 定义边栏导航
# with st.sidebar:
#     choose = option_menu('祝钰博的网站', ['网站介绍', '技术解析'],
#                          icons=['house', 'book-half'])
#
# if choose == '网站介绍':
#     # 定义页面标题
#     st.title('欢迎来到祝钰博的AI问答网站')
#     # 写入文本
#     st.write('这个网站用于回答和sam Altman相关问题，请按照说明使用，如果有问题请联系我')
# elif choose == '技术解析':
#     st.title('技术详解')
#     # 写入文本
#     st.write('聊天助手基于LLM, langchain, pinecone组成的检索增强技术， 主要善于回答和sam Altman相关问题')
#
#
...
# #
# llm = ChatOpenAI(model_name="gpt-4", openai_api_key = "sk-proj-LhCKCo9Qy6oiEDbngF2ST3BlbkFJOs9n8zGz0mgfzfJ6Wy8G")
#
